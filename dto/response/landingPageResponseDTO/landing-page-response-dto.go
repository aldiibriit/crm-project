package landingPageResponseDTO
...
type LandingPropertiDtoRes struct {
	PropertiTerdekat []DetailPropertiDtoRes `json:"propertiTerdekat"`
	Properti360      []DetailPropertiDtoRes `json:"properti360"`
	PropertiByCity   interface{}            `json:"propertiByCity"`
}
...
type DetailPropertiDtoRes struct {
	...
	ImageProperti     []ImageProperti `json:"imageProperti" gorm:"foreignKey:TrxId;references:ImagePropertiId"`
	ImageProject      []ImageProperti `json:"imageProject" gorm:"foreignKey:TrxId;references:ImageProjectId"`
}
