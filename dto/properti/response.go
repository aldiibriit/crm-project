...
type AdvancedFilter struct {
	DetailProperti  DetailProperti     `json:"detailProperti" gorm:"embedded"`
	...
	ImageProperti   []TblImageProperti `json:"imageProperti" gorm:"foreignKey:TrxId;references:ImagePropertiId"`
